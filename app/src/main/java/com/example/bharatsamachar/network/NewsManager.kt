...
import com.example.bharatsamachar.models.ArticleCategory
import com.example.bharatsamachar.models.TopNewsResponse
import com.example.bharatsamachar.models.getArticleCategory
        ...
        service.enqueue(object : Callback<TopNewsResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    Log.d("category", "${response.code()}")
                }
            }

            override fun onFailure(call: Call<TopNewsResponse>, t: Throwable) {
                Log.d("category", "${t.printStackTrace()}")
            }
